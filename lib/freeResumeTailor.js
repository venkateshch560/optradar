const skillKeywords = [
  ...
  "etl","data analysis","business analysis","reporting","dashboard",
  "power query","dax","javascript","react","node","api","rest",
  "agile","scrum","jira","git","docker","kubernetes","devops",
...
Data-driven professional with experience in ${analysis.matchedSkills.slice(0, 6).join(", ") || "analytics, reporting, and business problem-solving"}. Skilled in translating business needs into actionable insights, building reports, analyzing data, and supporting decision-making using modern analytics tools.
